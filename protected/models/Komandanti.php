...
/**
 * This is the model class for table "komandanti".
 *
 * The followings are the available columns in table 'komandanti':
 * @property integer $id
 ...
 */
class Komandanti extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Komandanti the static model class
	 */
